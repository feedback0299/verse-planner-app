export const ka_translations = {
  ...
  calendar: {
    ...
    monthly: {
      title: "ಮಾಸಿಕ ಬೈಬಲ್ ಯೋಜಕ",
      subtitle: "ನಿಮ್ಮ ದಿನನಿತ್ಯದ ಬೈಬಲ್ ಅಧ್ಯಯನವನ್ನು ಯೋಜಿಸಿ",
      dayNamesFull: ['ಭಾನುವಾರ', 'ಸೋಮವಾರ', 'ಮಂಗಳವಾರ', 'ಬುಧವಾರ', 'ಗುರುವಾರ', 'ಶುಕ್ರವಾರ', 'ಶನಿವಾರ']
    }
  },
  verseDialog: {
    addTitle: "ಬೈಬಲ್ ಅಧ್ಯಯನ ನಮೂದನ್ನು ಸೇರಿಸಿ",
  ...
  messages: {
    ...
    verseNotFoundDesc: "ವಚನವನ್ನು ಕಂಡುಹಿಡಿಯಲಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ನಿಮ್ಮ ಉಲ್ಲೇಖದ ಸ್ವರೂಪವನ್ನು ಪರಿಶೀಲಿಸಿ (ಉದಾ. 'ಯೋಹಾನ 3:16').",
    searchError: "ಹುಡುಕಾಟ ದೋಷ",
    searchErrorDesc: "ವಚನವನ್ನು ಹುಡುಕಲು ವಿಫಲವಾಗಿದೆ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.",
    entrySaved: "ನಮೂದು ಉಳಿಸಲಾಗಿದೆ",
    entrySavedDesc: "ನಿಮ್ಮ ಬೈಬಲ್ ಅಧ್ಯಯನ ನಮೂದನ್ನು ಯಶಸ್ವಿಯಾಗಿ ಉಳಿಸಲಾಗಿದೆ."
  },
  language: {
